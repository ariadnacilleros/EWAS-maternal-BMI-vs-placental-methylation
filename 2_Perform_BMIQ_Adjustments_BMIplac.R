...
load("1_BasicQC_and_FunctionalNormalization.RData")

##############################################################################################
#### Read in BMIQ Function from Teschendorf (2013) PMID: 23175756 ############################
##############################################################################################
...
##############################################################################################
#### Re-order annotation file, recode probe-type, then run BMIQ ##############################
##############################################################################################
...
## Run BMIQ function (Slow Process):
Sys.time()
...
save(annot,pd,FunNorm.BMIQ, file = "2_BMIQ_Adjsuted.RData")
